...
pub fn rasterizeGeneratedBoxAlpha(pixels: []u8, width: u16, height: u16, codepoint: u32, box_drawing: render.BoxDrawingStroke) void {
    switch (codepoint) {
...
pub fn rasterizeBoxLines(pixels: []u8, width: u16, height: u16, lines: BoxLines, box_drawing: render.BoxDrawingStroke) void {
...
pub fn rasterizeRoundedCorner(pixels: []u8, width: u16, height: u16, corner: RoundedCorner, box_drawing: render.BoxDrawingStroke) void {
...
pub fn rasterizeCrossLine(pixels: []u8, width: u16, height: u16, left: bool, box_drawing: render.BoxDrawingStroke) void {
