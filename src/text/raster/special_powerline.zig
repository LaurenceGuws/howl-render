...
pub fn rasterizeGeneratedPowerlineAlpha(pixels: []u8, width: u16, height: u16, codepoint: u32, box_drawing: surface.BoxDrawingRasterMetrics) void {
    switch (codepoint) {
...
fn rasterizePowerlineHalfDiagonal(pixels: []u8, width: u16, height: u16, left: bool, box_drawing: surface.BoxDrawingRasterMetrics) void {
...
fn rasterizePowerlineD(pixels: []u8, width: u16, height: u16, left: bool, filled: bool, box_drawing: surface.BoxDrawingRasterMetrics) void {
    if (filled) {
...
fn rasterizePowerlineRoundedD(pixels: []u8, width: u16, height: u16, left: bool, box_drawing: surface.BoxDrawingRasterMetrics) void {
