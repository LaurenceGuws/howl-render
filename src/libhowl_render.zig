const surface_text_ffi = @import("ffi.zig");
...
comptime {
    ...
    @export(&surface_text_ffi.release, .{ .name = "howl_render_prepared_surface_release" });
    @export(&surface_text_ffi.describe, .{ .name = "howl_render_prepared_surface_describe" });
    @export(&surface_text_ffi.buffer, .{ .name = "howl_render_prepared_surface_buffer" });
    @export(&surface_text_ffi.diagnostics, .{ .name = "howl_render_prepared_surface_diagnostics" });
