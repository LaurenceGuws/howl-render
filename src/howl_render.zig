...
pub const SurfaceTextConfig = surface_text.SurfaceTextConfig;
...
pub const SurfaceText = surface_text.SurfaceText;
...
pub const composeSurfaceBuffer = surface_buffer.compose;
